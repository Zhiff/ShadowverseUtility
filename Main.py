...
# ws.SVO_initial_scraper('paste excel file here')


# Website Scraping : JCG, MSCUP, SVO_Top
ws.JCG_scraper('https://sv.j-cg.com/compe/view/entrylist/2343/json')
# ws.manasurge_bfy_scraper('https://dtmwra1jsgyb0.cloudfront.net/tournaments/5f1e79da534e897bd0c64673/teams')
# ws.SVO_tops_scraper('https://dtmwra1jsgyb0.cloudfront.net/stages/5f1266601047db149e9edf9e/latest-round-standings')
